...
import 'package:arcade/widgets/manager_menu.dart';
import 'package:flutter/material.dart';
import 'package:latlong2/latlong.dart';
import 'package:provider/provider.dart';

class FloatingMapMenu extends StatelessWidget {
  const FloatingMapMenu({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            if (authVM.isAuthenticated() && authVM.isUserManager()) ...[
              SizedBox(
                height: 68,
                width: 68,
                child: FilledButton(
